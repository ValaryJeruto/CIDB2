...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\Úser\PycharmProjects\Case Investigation Form for covid-19\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\Úser\PycharmProjects\Case Investigation Form for covid-19\venv\Scripts\deactivate.nu'
